            ...
            for(var x=0; x < data.length; x++){
                ...
                for(var i=0; i < categoria.sub_categoria.length; i++){
                    ...
                    for(var z=0; z < sub_categoria.skills.length; z++){
                        ...
                        icon_remove.setAttribute("class", "glyphicon glyphicon-remove quitar_skill");
                        icon_remove.setAttribute("onclick", "alert('Eliminando');eliminar_nivel();");
...
</div><?php /**PATH /var/www/sistema_skills/resources/views/misskills/table.blade.php ENDPATH**/ ?>