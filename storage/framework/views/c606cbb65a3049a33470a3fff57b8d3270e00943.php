        ...
        <div class="box box-primary col-lg-12">
            ...
            <div class="box-body">
                <form id="rollbackForm">
                    <input type="hidden" name="_token" id="rbToken" value="<?php echo csrf_token(); ?>"/>
...
<script>
    ...
    $(function () {
        ...
        $(document).ready(function () {
            ...
            var commonComponent = $(htmlStr).filter("tr").load('<?php echo e(route('io_field_template')); ?>');
            var relationStr = '<tr class="relationItem" style="display: table-row;"></tr>';
            var relationComponent = $(relationStr).filter("tr").load('<?php echo e(route('io_relation_field_template')); ?>');
            ...
            $("#form").on("submit", function () {
                ...
                $.ajax({
                    url: '<?php echo e(route('io_generator_builder_generate')); ?>',
                   // type: "POST",
                    method: "POST",
                    dataType: 'json',
            ...
            $('#rollbackForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('io_generator_builder_rollback')); ?>',
                    method: "POST",
                    dataType: 'json',
                    contentType: 'application/json',
                    data: JSON.stringify(data),
            ...
            $('#schemaForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('io_generator_builder_generate_from_file')); ?>',
                    type: 'POST',
...
<?php /**PATH C:\xampp\htdocs\sistema_skills\vendor\infyomlabs\generator-builder\src/../views//builder.blade.php ENDPATH**/ ?>