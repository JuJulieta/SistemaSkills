<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <?php echo Form::open(['route' => 'skillsConsultores.store']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/skills_orbisdata/resources/views/skills_consultores/create.blade.php ENDPATH**/ ?>