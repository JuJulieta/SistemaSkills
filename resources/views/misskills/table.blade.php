<div class="table-responsive">
    ...
    <script type="text/javascript">
        ...
        @foreach($lst_skillsConsultor as $mi_skill)
        misSkills.push({
            con_id : {{ $mi_skill-> con_id }},
            skl_id : {{ $mi_skill-> skl_id }},
            nvl_id : {{ $mi_skill-> nvl_id }}
        });
        @endforeach
        ...
        @foreach($lst_subcatgorias as $sub_categoria)
        ...
        function agregar_nivel(categoria_id, sub_categoria_id, skill_id, nivel_id, nivel_nombre){
            ...
            $.ajax({
                type: "PUT",
                url: '{{ url('') }}' + '/api/consultorSkill/' + id + '/' + skill_id + '/' + nivel_id ,
                dataType: "json",
        ...
        function eliminar_nivel(categoria_id, sub_categoria_id,skill_id){
            ...
            $.ajax({
                type: "delete",
                url: '{{ url('') }}' + '/api/consultorSkill/' + id + '/' + skill_id ,
                dataType: "json",
                success: function (result, status, xhr) {
                    console.log(result);
                },
